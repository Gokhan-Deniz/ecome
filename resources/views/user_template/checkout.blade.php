      ...
      <h2>ÖDEME NOKTASI</h2>
        <div class="row">
            <div class="col-8">
                <div class="box_main">
                    <h3>BİLGİLERİNİZ</h3>
                    <p>Şehir- {{$shipping_address->city_name}}</p>
                    <p>Adres- {{$shipping_address->street_info}}</p>
                    <p>Posta Kodu- {{$shipping_address->postal_code}}</p>
                    <p>Telefon- {{$shipping_address->phone_number}}</p>
                </div>
            </div>

            <div class="col-4">
                <div class="box_main">
                    <h3>ALACAK OLDUĞUNUZ ÜRÜNLER</h3>
            ...
            <form action="" method="POST">
                @csrf
                <input type="submit" value="İPTAL ET" class="btn btn-danger mr-3">
            </form>
            <form action="{{route('placeorder')}}" method="POST">
                @csrf
                <input type="submit" value="SATIN AL" class="btn btn-primary">
            </form>
        </div>
      </div>
