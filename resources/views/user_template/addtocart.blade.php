                        ...
                        <table class="table">
                            ...
                            @foreach ($cart_items as $item)
                                <tr>
                                    ...
                                    -->
                                    <td><img src="{{ asset($img) }} " style="height: 75px;"></td>
                                    <td>{{$product_name}}</td>
                                    <td>{{$item->quantity}}</td>
                                    <td>{{$item->price}}</td>
                                    <td><a href="{{ route('removeitem', $item->id) }}" class="btn btn-warning">Sil</a></td>
                                </tr>
                                @php
                           ...
                           <tr>
                              ...
                              <td><a href="{{route('shippingaddress')}}" class="btn btn-primary">Onayla</a></td>
                              @endif
                           </tr>
                        </table>
                    </div>
