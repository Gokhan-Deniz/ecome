      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-8">
               ...
               <p class="price_text text-left"><span style="color: #262626;">{{$product->price}}₺</span></p>
               </div>
               <div class="my-3 product-details">
                  ...
                  <ul class="p-2 bg-light my-2">
                     ...
                     <li>Kalan sayısı - {{$product->quantity}}</li>
                  </ul>
               </div>
               <div class="btn_main">
                  <form action="{{route('addproducttocart',$product->id)}}" method="POST">
                     ...
                     <div class="form-group">
                        ...
                        <label for="quantity">Kaç tane alıyorsun?</label>
                        <input class="form-control" type="number" min='1' max='10' placeholder="1" name="quantity">
                     </div><br>
                     <input class="btn btn-warning" type="submit" value="Sepete ekle">
                     <div class="btn btn-info"><a href="/">Geri Dön</a></div>
                  </form>
               </div>
               </div>
            </div>
