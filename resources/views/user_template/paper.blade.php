   ...
   <body>
      ...
      <div class="container py-5" style="margin-top: 200px;">
        <div class="row">
            <div class="col-12">
                <div class="box_main">
                    <form action="{{route('addpaper')}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="TC_No">T.C. Numara</label>
                        ...
                        <div class="form-group">
                            <label for="Baba_ad">Baba Adı</label>
                            <input type="text" class="form-control" name="Baba_ad">
                        </div>
                        <div class="form-group">
                            <label for="Dogum_yeri">Dogum Yeri</label>
                            <input type="text" class="form-control" placeholder="İl/İlçe" name="Dogum_yeri">
                        </div>
                        <div class="form-group">
                            <label for="Dogum_tarih">Doğum Tarihi</label>
                            <input type="text" class="form-control" placeholder="gg/aa/yyyy" name="Dogum_tarih">
                        </div>
                        <div class="form-group">
                            <label for="Ev">İkametgah</label>
                            <input type="text" class="form-control" name="Ev">
                        </div>
                        <div class="form-group">
                            <label for="Sicil">Sicil Kaydı</label>
                            <select class="form-control" name="Sicil" id="Sicil">
                            <option selected>Kaydınız</option>
                            <option value="Var">Var</option>
                            <option value="Yok">Yok</option></select>
                        </div>
                        <input type="submit" value="Başvur" class="btn btn-primary">
                    </form>
                </div>
            </div>
        </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="input_bt">
               ...
               <span class="subscribe_bt" id="basic-addon2"><a href="https://mail.google.com/mail/u/">Abone Ol</a></span>
            </div>
