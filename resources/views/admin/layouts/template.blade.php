        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admindashboard') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Gunship</span>
            </a>

            <a href="{{ route('admindashboard') }}" class="layout-menu-toggle menu-link text-large ms-auto d-block d-xl-none">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Kategori</span></li>
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Alt Kategori</span></li>
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Ürünler</span></li>
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Siparişler</span></li>

              <li class="menu-item">
              <a href="{{ route('pendingorder') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Yeni Siparişler</div>
              </a>
            </li>

            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Başvurular</span></li>

              <li class="menu-item">
              <a href="{{ route('basvuru') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Ruhsat Başvuru</div>
              </a>
            </li>
          </ul>
        </aside>
